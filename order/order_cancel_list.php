            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  $result = mysqli_query($conn," SELECT * FROM sale_order WHERE order_status='cancel' ORDER BY order_no DESC"); 
                    ...
                    <?php 
                     echo "<td>"; echo "<a href='order_cancel_show.php?order_no=".$row['order_no']."'><button class='btn btn-success'>Show</button></a>";  
                     echo "</td>";
