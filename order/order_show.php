              ...
              <div class="row">
                <div class="col-12">
                  ...
                  if(isset($_SESSION['user_login']))
                  {
                    ...
                    {
                      ?>
                            <a class="btn btn-success" href="order_print.php?order_no=<?php echo $order_no;?>" role="button">Print ใบแสกนqrcode</a>
                            <?php
                      
                    }
                  }
                  ?>
                            <a class="btn btn-secondary" href="order_list.php" role="button"> ย้อนกลับ </a>
                            <a class="btn btn-primary" href="order_confirm.php?order_no=<?php echo $order_no;?>" role="button">ครัว Confirm เสิร์ฟอาหาร</a>
                          </div>
                      </div>
                      <!-- /.card-header -->
                    <!-- /.card-body -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                        <label class="col-form-label">วันที่รับบริการ</label> 
                                                        <div><?php 
                                                        $newDate = date("d-m-Y", strtotime($row['order_date']));
                                                        echo $newDate;?>                                                       
                                                        </div> </div>
                                                        <div class="form-group">
                                                        <label class="col-form-label">เวลารับบริการ</label> 
                                                        <div><?php 
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                                                          ...
                                                          <?php 
                                                                ...
                                                                $sql2 = "SELECT * FROM orders_items INNER JOIN menu on orders_items.name=menu.name  WHERE order_status='order_in' AND orders_items.order_no='".$order_no."'";
                                                                //echo $sql2;exit();
