        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Served</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  $result = mysqli_query($conn," SELECT * FROM sale_order WHERE order_status='serve' ORDER BY order_no DESC"); 
                    ...
                    <?php 
                     echo "<td>"; echo "<a href='order_served_show.php?order_no=".$row['order_no']."'><button class='btn btn-success'>แสดง</button></a>";  
                     echo "</td>";
