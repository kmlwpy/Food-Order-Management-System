                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Cancel Data</h3> 
                      </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                                                          ...
                                                          <?php 
                                                                ...
                                                                $sql2 = "SELECT * FROM orders_items INNER JOIN menu on orders_items.name=menu.name AND order_status='cancel'  WHERE orders_items.order_no='".$order_no."'";
                                                                //echo $sql2;exit();
