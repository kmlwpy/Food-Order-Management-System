              ...
              <div class="row">
                <div class="col-12">
                  ...
                  if(isset($_SESSION['user_login']))
                  {
                    ...
                    {
                      ?>
                            <a class="btn btn-success" href="order_succeed_print.php?order_no=<?php echo $order_no;?>" role="button">Print ใบเสร็จรับเงิน </a>
                            <?php
                      
                    }
                  }
                  ?>
                            <a class="btn btn-secondary" href="order_succeed_list.php" role="button"> ย้อนกลับ </a>
