        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Order Served</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  if(isset($_SESSION['user_login']))
                  {
                    ...
                    {
                      ?>
                            <a class="btn btn-success" href="order_served_print.php?order_no=<?php echo $order_no;?>" role="button">Print ใบแจ้งชำระเงิน </a>
                            <?php
                  ...
                  ?>
                            ...
                            <a class="btn btn-secondary" href="order_served_list.php" role="button"> ย้อนกลับ </a>
                            <?php 
                  if(isset($_SESSION['user_login']))
                  {
                    $checkuser = checkuser($_SESSION['user_login'],'sale');
                    ...
                    {
                      ?>
                             <a class="btn btn-primary" href="order_served_confirm.php?order_no=<?php echo $order_no;?>" role="button"> Confirm การชำระเงิน</a>
                            <?php
