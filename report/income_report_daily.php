...
<div class="wrapper">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <th style="text-align:center;">รายได้รวมต่อวัน</th>
                  </thead>
  ...
  ?>                 
                  ...
                  if(!$conn)
                  {  die("Error ".mysqli_connect_error()); }
                  $sql = "SELECT  DAY(sale_order.order_date)  as DAY ,monthname(sale_order.order_date)  as MN ,YEAR(sale_order.order_date)  as YEAR
                  ,SUM(orders_items.price*orders_items.qty) as TOTAL FROM sale_order JOIN orders_items 
                  ON sale_order.order_no=orders_items.order_no AND sale_order.order_status='succeed' 
                  GROUP BY YEAR(sale_order.order_date),month(sale_order.order_date)DESC,day(sale_order.order_date) DESC";
                  ...
                  while($row=mysqli_fetch_assoc($result))
                  
                    {
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;"><?php echo $row['MN'];?></td>
